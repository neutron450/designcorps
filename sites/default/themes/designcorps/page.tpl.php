...
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?>">
  <div id="page" class="page">
    <div id="page-inner" class="page-inner">
	  ...
	  <div id="page-grid-wrap" class="grid16-16">
	                      ...
	                      <div id="content-group-inner" class="content-group-inner inner">
	                        ...
	                        <div id="content-top" class="content-top row nested">
	                          <div id="content-top-inner" class="content-top-inner inner">
	                            ...
	                            <?php print theme('grid_block', $messages, 'content-messages'); /// TODO find better way to deal with error messages here ?>
  ...
  <?php print $closure; ?>
  <?php print $admin_toolbar; ?>
  <script type="text/javascript">
    $(document).ready(function(){
    	$('.view-id-portfolio select').customStyle();

    	$("img").parent("a:hover").css("background", "none");
